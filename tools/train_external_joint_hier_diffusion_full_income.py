...
Shared-latent hierarchical diffusion trainer for the 5-variable full external schema:
  ...
  AGEP_fine(10) x SEX(2) x SCHL_fine(5) x ESR_fine(5) x INCOME_fine(10) = K=5000
"""
...
import tools.train_external_joint_hier_diffusion_full as base
from tools.build_external_target_v1_michigan import AGE_LABELS, ESR_LABELS, SCHL_LABELS, SEX_LABELS
from tools.external_income_v1_schema import INCOME_LABELS, INCOME_LITE_LABELS, INCOME_TO_LITE
...
base.FINE_VARIABLE_ORDER = ["AGEP_bin", "SEX", "SCHL_allpop", "ESR_allpop", "PINCP_allpop_bin"]
base.COARSE_VARIABLE_ORDER = ["AGEP_bin", "SEX", "SCHL_allpop", "ESR_allpop", "PINCP_allpop_bin"]
...
def _build_fine_to_coarse_matrix_full_income() -> np.ndarray:
    ...
    income_coarse_idx = {lab: i for i, lab in enumerate(INCOME_LITE_LABELS)}
        ...
        for si, _ in enumerate(base.FINE_CATEGORIES["SEX"]):
            for schl_lab in base.FINE_CATEGORIES["SCHL_allpop"]:
                ...
                for esr_lab in base.FINE_CATEGORIES["ESR_allpop"]:
                    ...
                    for income_lab in base.FINE_CATEGORIES["PINCP_allpop_bin"]:
                        wc = income_coarse_idx[INCOME_TO_LITE[income_lab]]
...
base._build_fine_to_coarse_matrix_full = _build_fine_to_coarse_matrix_full_income
