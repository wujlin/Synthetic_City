...
import tools.train_external_joint_hier_diffusion_full_earn as _full_earn  # noqa: F401
...
from tools.train_us_puma_external_v1_diffusion import _load_condition_specs_from_schema, _load_external_condition_matrix
...
def _load_stage1_model(*, checkpoint_path: pathlib.Path, timesteps: int, seed: int) -> tuple[Any, dict[str, Any]]:
    ...
    if ckpt_format == "synthpop.external_c2f_full_earn_stage1_coarse_diffusion.v0":
        import tools.train_external_c2f_full_earn_stage1_coarse as stage1_coarse
