...
from tools.model.eval_external_c2f_age_schl_pipeline import (
    STAGE1_K,
    STAGE1_SHAPE,
...
def main() -> None:
    ...
    for r in final_df.to_dict(orient="records"):
        ...
        from tools.model.train_us_puma_5var_diffusion import _ipf_nd, _tvd  # local import to keep file self-contained
