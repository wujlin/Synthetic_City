...
from tools.external_v1_variant_presets import AGE_LITE_LABELS, SCHL_LITE_LABELS
from tools.train_external_c2f_age_schl_teacher import _project_to_parent_table, _uniform_from_parent_table
