...
for SEED in $SEEDS; do
  ...
  SEED="$SEED" RUN_DIR="$RUN_DIR" bash tools/run_external_joint_hier_diffusion_full_earn.sh
  RUN_DIRS+=("$RUN_DIR")
done

"${PYTHON_BIN:-python}" -u tools/summarize_external_joint_hier_diffusion_runs.py \
