...
from tools.eval_external_c2f_full_earn_pipeline import _coarse_marginals_from_full_ext, _load_stage1_model
from tools.external_c2f_full_earn_schema import (
    COARSE_CATEGORIES,
    COARSE_K,
    COARSE_SHAPE,
...
from tools.train_us_puma_external_v1_diffusion import _load_condition_specs_from_schema, _load_external_condition_matrix, _load_var_specs_from_schema
...
def main() -> None:
    ...
    if bool(args.use_stage1_coarse_ipf_for_condition) and bool(args.append_true_coarse_rows):
        stem = "extc2f_full_earn_stage1ipfcondmix_pums_2023_puma_us"
    elif bool(args.use_stage1_coarse_ipf_for_condition):
        stem = "extc2f_full_earn_stage1ipfcond_pums_2023_puma_us"
    else:
        stem = "extc2f_full_earn_teacher_pums_2023_puma_us"
