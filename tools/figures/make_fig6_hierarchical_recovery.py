...
from tools.model.external_c2f_full_earn_schema import COARSE_SHAPE, FULL_SHAPE, coarse_from_full_flat
from tools.figures.make_fig4_michigan_regional_validation import (
    FULL_VARIABLE_ORDER,
    ONE_SHOT_CONFIGS,
    PIPELINE_CONFIGS,
